...
class ModuleManager(commands.Cog):
    ...
    @commands.command(brief="load a module, module names are listed in the help menu overview", usage="{}load".format(config["prefix"]))
    ...
    @commands.command(brief="unload a module, module names are listed in the help menu overview", usage="{}unload".format(config["prefix"]))
    ...
    @commands.command(
        name="reload", brief="reload a module, module names are listed in the help menu overview", usage="{}reload".format(config["prefix"])
    )
