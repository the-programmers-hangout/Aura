...
* tidy up code
* add tests for every major functionality that does not require mocking discord libraries (**done**)
* add tests for every major functionality that does require mocking discord libraries
