...
### 0.4.0
* add command to reset karma of user (all in guild)
* add command to reset karma of user (type in guild)
* add command to copy karma of user (all in guild)
* add command to copy karma of user (type in guild)
